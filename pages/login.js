...
export default function Login() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "24px 20px", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ width: "100%", maxWidth: 400, animation: "slideUp 0.4s ease", position: "relative", zIndex: 1 }}>
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          <div style={{ width: 64, height: 64, borderRadius: 20, margin: "0 auto 16px", background: "linear-gradient(135deg, #9B8FF0, #7C6FE0)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 28, boxShadow: "0 8px 32px rgba(124,111,224,0.4)" }}>💟</div>
          <h1 style={{ fontSize: 26, fontWeight: 800, margin: "0 0 6px" }}>IStarMate</h1>
        ...
        <div className="card" style={{ padding: "28px 24px" }}>
          <form onSubmit={handleSubmit}>
            ...
            <input className="input" type="password"
              placeholder={mode === "register" ? "设置密码（至少6位）" : "••••••••"}
            ...
            {mode === "register" && (
              <>
                ...
                <input className="input" type="text" placeholder="例如 ISMABCD"
                  ...
                  style={{ letterSpacing: inviteCode ? 3 : 0 }}
                />
              </>
            )}
