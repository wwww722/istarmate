...
2. memories：从对话中提取值得长期记住的事，帮助许安和/余生以后像老朋友一样记得TA。每条包含：
   - category: 从以下6类选一个：
     "heart"(心事：TA的感受、想法、烦恼) / "people"(人际：对TA重要的人，如家人朋友老师) / "goal"(目标：TA想做到的事、愿望) / "work"(作品：TA亲手做出来的东西、代码项目) / "milestone"(里程碑：TA走过的重要节点、第一次) / "followup"(下次问问：这次没聊完、下次值得主动关心的事)
   - key: 简短标识（4-10字，如"和妈妈冷战""期中考试""ToDo小程序"）
   - detail: 具体内容（一句话）
   - importance: 1-3（3=对TA很重要的人或事）
   只提取明确提到的、具体的信息。没有就返回空数组。不要编造。

返回格式示例：
{"summary":"提到期中考试压力大，和好朋友闹了矛盾感到孤单。","memories":[{"category":"heart","key":"期中考试焦虑","detail":"下周期中考试，很焦虑怕考不好","importance":2},{"category":"people","key":"好朋友小雨","detail":"最好的朋友，最近因为误会闹矛盾","importance":3},{"category":"followup","key":"和小雨的误会","detail":"还没和好，下次可以问问后来怎么样了","importance":2}]}`;
