...
export const MODEL_PERSONAS = {
  doubao_companion: {
    ...
    tagline: "像真人朋友一样聊得来",
    vendor: "ByteDance",
    primaryFor: ["hoshino"],   // 星野（情绪陪伴）默认用豆包人格
...
`,
  ...
  claude_code: {
    id: "claude_code",
    displayName: "Claude·代码",
    emoji: "🧩",
    tagline: "最懂代码的学长，严谨又贴心",
    vendor: "Anthropic",
    primaryFor: ["kawa"],   // 川（编程导师）默认用 Claude 级代码人格
...
`,
  ...
  gpt_general: {
    ...
    vendor: "OpenAI",
    primaryFor: ["mingchuan"], // 明川老师（深度家族视角）默认 GPT 级深度
...
export const CHARACTER_DEFAULT_PERSONA = {
  hoshino:   "doubao_companion",
  kawa:      "claude_code",
  mingchuan: "gpt_general",
};
